...
<body>
        ...
        <div id="emotion" class="alert alert-secondary " role="alert">
            <div class="row ">
                ...
                <p class="col-12 col-md-4">你還未登入 ! 請點擊
                    ...
                    <img src="img\cancel.png" onclick="closebar()">
                </p>
            </div>
        </div>
    ...
    <form id="needs-validation" novalidation>
  <div class="form-row">
        ...
        <div class="d-flex justify-content-between mt-4">
            ...
            <div class="col-12 col-md-7 ">
                <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img class="d-block w-100" src="http://lorempixel.com/800/400/technics/1/"
                                alt="First slide">
                        </div>
                        <div class="carousel-item">
                            <img class="d-block w-100" src="http://lorempixel.com/800/400/technics/2/"
                                alt="Second slide">
                        </div>
                        <div class="carousel-item">
                            <img class="d-block w-100" src="http://lorempixel.com/800/400/technics/3/"
                                alt="Third slide">
                        </div>
                    </div>
                    <a class="carousel-control-prev" href="#carouselExampleControls" role="button" data-slide="prev">
